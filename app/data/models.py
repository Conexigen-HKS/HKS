...
class Professional(Base):
    ...
    is_approved = Column(bool, default=False)
...
class ProfessionalProfile(Base):
    ...
    chosen_offer = relationship("CompanyOffers", back_populates="chosen_by_professionals")
...
class Requests(Base):
    ...
    professional = relationship("ProfessionalProfile", foreign_keys=[professional_profile_id], back_populates="requests")
...
class Requirements(Base):
    ...
    job_ad_reqs = relationship("JobAdReq", back_populates="requirements")
