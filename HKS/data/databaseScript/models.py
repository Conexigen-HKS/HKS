...
#
#     # Relationship with ProfessionalProfile, explicitly specifying the foreign key
#     professional_profile = relationship("ProfessionalProfile", back_populates="user",
#                                         foreign_keys="ProfessionalProfile.professional_id")
...
#     is_approved = Column(Integer, nullable=True)  # or Boolean if you want it as True/False
...
#
#     # Relationships
#     user = relationship("UsersBase", back_populates="professional", foreign_keys=[user_id])
#     profiles = relationship("ProfessionalProfile", back_populates="professional",
#                             foreign_keys="ProfessionalProfile.professional_id")
#
#
...
#
#     # Relationships
#     professional = relationship("Professionals", back_populates="profiles", foreign_keys=[professional_id])
#     user = relationship("UsersBase", back_populates="professional_profile", foreign_keys="UsersBase.user_id")
